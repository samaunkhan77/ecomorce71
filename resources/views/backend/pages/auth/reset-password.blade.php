        ...
        <div class="minimal-card-wrapper">
            <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                ...
                <div class="card-body p-sm-5">
                    <h2 class="fs-20 fw-bolder mb-4">Reset Password <a href="javascript:void(0);" class="float-end fs-12 text-primary"></a></h2>
                    <h4 class="fs-13 fw-bold mb-2">Please enter Password .</h4>
                    <form action="{{route('reset.password.post')}}" method="post" class="w-100 mt-4 pt-2">
                        @csrf
                        <div id="otp" class="inputs d-flex flex-row justify-content-center mt-2">
                            <input class="m-2 text-center form-control rounded" type="password" name="password" required>
