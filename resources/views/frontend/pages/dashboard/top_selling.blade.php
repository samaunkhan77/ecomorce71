        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                ...
                <div class="product-list-small animated animated">
                    <article class="row align-items-center hover-up">
                        <figure class="col-md-4 mb-0">
                            <a href='shop-product-right.html'><img src="{{asset('assets/imgs')}}/shop/thumbnail-10.jpg" alt="" /></a>
                        </figure>
                        <div class="col-md-8 mb-0">
                            <h6>
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-md-4 mb-0">
                            <a href='shop-product-right.html'><img src="{{asset('assets/imgs')}}/shop/thumbnail-11.jpg" alt="" /></a>
                        </figure>
                        <div class="col-md-8 mb-0">
                            <h6>
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-md-4 mb-0">
                            <a href='shop-product-right.html'><img src="{{asset('assets/imgs')}}/shop/thumbnail-12.jpg" alt="" /></a>
                        </figure>
                        <div class="col-md-8 mb-0">
                            <h6>
