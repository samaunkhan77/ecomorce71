                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    @else
                              <div class="header-action-icon-2">
                                 <a href='{{route('customer.login')}}'><span class="lable ml-0"><i class="fa-regular fa-user"></i> Log in</span></a>
                             </div>
                             @endif
                            </div>
                        </div>
            ...
            <div class="header-wrap header-space-between position-relative">
                ...
                <div class="header-nav d-none d-lg-flex">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                <li class="hot-deals"><img src="{{asset('assets/imgs')}}/theme/icons/icon-hot-white.svg" alt="hot deals" /><a href='shop-grid-right.html'>Deals</a></li>
                                <li>
                ...
                <div class="hotline d-none d-lg-flex">
                    <img src="{{asset('assets/imgs')}}/theme/icons/icon-headphone-white.svg" alt="hotline" />
